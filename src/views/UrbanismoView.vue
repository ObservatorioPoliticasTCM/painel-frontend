<template>
  <SnapPage>
    <DashboardFrame
      ...
      identity="1"
      methodology-link="/infos/notas/Urbanismo/População em risco geológico e hidrológico (2025).pdf"
    ...
    <DashboardFrame
      ...
      identity="3"
      download-link="/dados/urbanismo/area-de-parques-municipais-e-estaduais.zip"
    />
    <DashboardFrame
    ...
    <DashboardFrame
      ...
      title="Déficit habitacional, domicílios não ocupados e domicílios em favelas"
      identity="5"
      download-link="/dados/urbanismo/deficit-habitacional-domicilios-nao-ocupados-e-domicilios-em-favelas.zip"
    />
    <DashboardFrame
      ...
      identity="6"
      download-link="/dados/urbanismo/unidades-habitacionais-entregues-ou-contratadas.zip"
    />
    <DashboardFrame
      ...
      identity="7"
      download-link="/dados/urbanismo/familias-beneficiadas-por-regularizacao-fundiaria-e-obras-em-assentamentos-precarios.zip"
    />
    <DashboardFrame
      ...
      identity="8"
      download-link="/dados/urbanismo/familias-beneficiarias-do-programa-de-auxilio-aluguel.zip"
    />
    <DashboardFrame
      ...
      identity="10"
      download-link="/dados/urbanismo/Quadro 7 - Relatório de Função Habitação.xlsx"
    />
    <DashboardFrame
      appid="18956ab0-d917-475f-8c94-aba437c955fc"
      sheet="SHsCbm"
      title="Despesas liquidadas em toda a função Habitação (2024)"
      identity="11"
      download-link="/dados/urbanismo/orcamento-habitacao.csv"
    />
  </SnapPage>
</template>
