<template>
  <SnapPage>
    <TextFrame title="Saúde" subtitle="Painel DataSP" snap-strategy="start">
      <article class="saude-letter-surface" aria-labelledby="saude-letter-title">
        <header class="saude-letter__header">
          <h1 id="saude-letter-title" class="saude-letter__title">Texto Introdutório</h1>
          <h1 id="saude-letter-title" class="saude-letter__title">Saúde</h1>
        </header>
        <div class="saude-letter" aria-describedby="saude-letter-title">
          <div class="saude-letter__columns">
            <div class="saude-letter__column">
              <p>
